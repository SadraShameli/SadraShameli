<!--
      ...
      ██╔╝       stdlib python in src/readme, fonts and all.
      ╚═╝        regenerate everything with `uv run readme`.
           ███████╗
