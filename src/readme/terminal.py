...
from .svg import MONO, MONO_ADVANCE, SANS, Theme, card_frame, clip_card, document, esc, font_css
...
DEVELOPER: list[Bullet] = [
    ...
    [("This README is a build artifact.", "lead"), ("The SVGs are generated by src/readme, a uv package using only the Python "
