...
NO_PILLOW = "readme photos: Pillow is missing, run `uv sync` for the dev group"
...
JOBS = {
    ...
    "shot-prop-calculator": (
        "Images/Screenshots/prop-calculator.jpg",
        418,
        261,
        0.5,
        0.0,
    ...
    "shot-minomarkt-nl": (
        "Images/Screenshots/minomarkt-nl.jpg",
        418,
        261,
        0.5,
        0.0,
    ...
    "yt-line-detection": (
        "Images/YouTube/1142rRZ3rzc.jpg",
        126,
        224,
        0.5,
        0.5,
...
def crop_box(
    src_w: int, src_h: int, w: int, h: int, fx: float, fy: float
...
def crop_all() -> None:
    try:
        ...
        raise SystemExit(NO_PILLOW) from None
