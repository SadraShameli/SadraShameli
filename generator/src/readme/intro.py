...
def intro(t: Theme) -> str:
    ...
    day = _panel(
        ...
        pal,
        "BY DAY",
        "Full-stack developer at Nobears",
        "Rotterdam. I ship and maintain 15+ WordPress platforms.",
        _sun(t, dx + 44, py + ph / 2),
    )
    night = _panel(
        nx,
        py,
        ...
        "BY NIGHT",
        "Trading NQ futures",
        "and teaching a Python engine to trade them with me.",
        _moon(t, nx + 44, py + ph / 2),
        reserve_right=170,
