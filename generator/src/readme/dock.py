...
DOCKS: dict[str, tuple[int, list[list[Link]]]] = {
    ...
    "project-sensorhub": (
        ...
        [
            [
                Link(
                    "Source code",
                    "https://github.com/SadraShameli/sensorhub",
                    "github",
                ),
    ...
    "project-projectai": (
        ...
        [
            [
                ...
                Link(
                    "Watch it drive",
                    "https://www.youtube.com/shorts/abyVlfAETG0",
                    "play",
                ),
            ]
        ],
    ...
    "youtube": (
        ...
        [
            [
                Link(
                    "Line detection",
                    "https://www.youtube.com/watch?v=1142rRZ3rzc",
                    "play",
                ),
                Link(
                    "Lidar ranging",
                    "https://www.youtube.com/watch?v=_C8PnLK2SWA",
                    "play",
                ),
                Link(
                    "Indoor test drive",
    ...
    "documents": (
        ...
        [
            ...
            [  # where I work(ed), and the one public repo not linked from a project card
                Link("Nobears", "https://www.nobears.com", "globe"),
                Link(
                    "Blue Star Planning",
                    "https://bluestarplanning.com",
                    "globe",
                ),
                Link(
                    "sadra.nl source",
                    "https://github.com/SadraShameli/sadra.nl",
                    "github",
                ),
            ],
        ],
...
def segment(
    ...
    lines = [
        f'<path d="M0 .5H{w:.2f}" stroke="{t.border}"/>'
    ]  # divider from the card / the row above
    if first:
        lines.append(
            f'<path d="M.5 0V{h - rl}'
            + (f"A{rl - 0.5} {rl - 0.5} 0 0 0 {rl} {h - 0.5}" if rl else "")
            + f'" '
    ...
    if bottom:
        lines.append(
            f'<path d="M{rl} {h - 0.5}H{w - rr:.2f}" stroke="{t.border}"/>'
        )
    ...
    body = (
        ...
        f'fill="{t.faint}">↗</text>' + "".join(lines)
    )
